...
downloadButton.addEventListener(
    ...
    async () => {
        ...
        /*
         * Convert the real QR canvas into
         * an actual PNG Blob.
         */
        ...
        canvas.toBlob(
            async (blob) => {
                ...
                /*
                 * Keep the Blob URL alive briefly
                 * so mobile/desktop browsers have
                 * enough time to start the download.
                 */
